...
public class LinkedListCycle {
	public static void main(String args[]) {
		...
		linkedList.appendIntoTail(new TestLinkedList.Node("101"));
		linkedList.appendIntoTail(new TestLinkedList.Node("201"));
		linkedList.appendIntoTail(new TestLinkedList.Node("301"));
		linkedList.appendIntoTail(new TestLinkedList.Node("401"));
		linkedList.appendIntoTail(new TestLinkedList.Node("201"));
